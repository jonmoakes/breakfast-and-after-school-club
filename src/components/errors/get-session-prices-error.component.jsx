...
import { contactRoute, userBookingsRoute } from "../../strings/strings";
  ...
  return (
    <>
      <ParentDiv>
        ...
        <Text>
          without this data, we cannot update your balance accordingly when
        ...
        <Text>please tap the button below to return to the bookings page"</Text>
      </ParentDiv>
