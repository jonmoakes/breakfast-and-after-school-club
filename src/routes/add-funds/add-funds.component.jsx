import useConfirmAddFundsAfterGettingClientSecretUseEffect from "./add-funds-hooks/use-confirm-add-funds-after-getting-client-secret-use-effect";
...
const AddFunds = () => {
  ...
  useConfirmAddFundsAfterGettingClientSecretUseEffect();
