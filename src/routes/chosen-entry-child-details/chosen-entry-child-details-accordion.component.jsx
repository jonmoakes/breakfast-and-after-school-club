          ...
          {shouldShowElement && (
            <AccordionContent>
              ...
              <Text>
                ...
                medical info, dietary requirements and additional info may not
                be visible if the parent has not entered anything for those
                fields when creating the child.
              </Text>
              <Text>
