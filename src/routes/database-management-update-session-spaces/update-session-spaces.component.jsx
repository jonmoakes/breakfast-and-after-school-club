      ...
      {databaseManagementIsLoading ? (
        ...
        <>
          <ParentDiv>
            ...
            <Text>
              <RedSpan>
                please don't leave this page before completing this step as your
                database data will be out of sync otherwise.
              </RedSpan>
            </Text>

            <Text>
              to fix this error, we need the following data which you will also
              find in the same email you used to update the users balance (
...
export default UpdateSessionSpaces;
