export const cleveleysPrimaryEnvVariables = {
  ...
  stripeSecretKey: import.meta.env.VITE_STRIPE_CLEVELEYS_PRIMARY_SECRET_KEY,

  appOwnerEmail: import.meta.env.VITE_CLEVELEYS_PRIMARY_SCHOOL_APP_OWNER_EMAIL,

  appOwnerId: import.meta.env.VITE_CLEVELEYS_PRIMARY_APP_OWNER_ID,

  userCollectionId: import.meta.env.VITE_CLEVELEYS_PRIMARY_USER_COLLECTION_ID,
