export const testSchoolEnvVariables = {
  databaseId: import.meta.env.VITE_TEST_SCHOOL_DATABASE_ID,

  stripePublishableKey: import.meta.env.VITE_STRIPE_TEST_SCHOOL_PUBLISHABLE_KEY,

  stripeSecretKey: import.meta.env.VITE_STRIPE_TEST_SCHOOL_SECRET_KEY,

  appOwnerEmail: import.meta.env.VITE_TEST_SCHOOL_SCHOOL_APP_OWNER_EMAIL,
  ...
  childrenCollectionId: import.meta.env.VITE_TEST_SCHOOL_CHILDREN_COLLECTION_ID,
  ...
  bookingTermsLink: import.meta.env.VITE_TEST_SCHOOL_BOOKING_TERMS_LINK,
};
