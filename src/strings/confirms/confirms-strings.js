...
export const cancelBookingConfirmSendEmailMessage = `<span style="font-size: 20px;"><span style="color: ${customYellow}">success! your booking was cancelled and your wallet balance updated.</span><br/>do you wish to be sent an email with a confirmation of the cancellation?<br/><br/>tap '<span style="color: ${customYellow}">cancel</span>' if you do <span style="color: ${customYellow}">NOT</span> wish to be sent an email.</span><br/>`;
