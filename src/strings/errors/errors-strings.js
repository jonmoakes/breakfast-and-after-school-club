...
export const bookingManuallyAddedSessionSpacesFailedErrorMessage = `<span style="font-size: 20px;">the booking was added, but there was an error updating the session spaces. please don't try to submit the form again, as you will end up with a double booking. Instead, please contact jonathan urgently, giving him the date of the session you were trying to book, the type of session and the number of children in the booking.</span>`;
