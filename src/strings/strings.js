...
export const failedToSendEmailInstructions = `<span style="font-size: 20px;">sorry, the email failed to send...please contact the school as soon as possible and give your name, email address and what you were trying to do, so we can fix our error. We apologise for the inconvenience. please tap ok to continue!</span>`;
...
export const BookingsOwnerRoute = "/bookings-owner";
